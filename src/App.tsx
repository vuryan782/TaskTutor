...
import { BookOpen, Home, Upload, FileQuestion, Calendar, TrendingUp, Users, Menu, LogOut, Bell, Search, Plus, ChevronRight, User } from 'lucide-react';
...
function ProfilePage() {
  ...
  const [lastName, setLastName] = useState('Woodall');
  const [email, setEmail] = useState('Jaydenwoodall09@gmail.com');
  const [school, setSchool] = useState('California State University, Long Beach');
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-gray-600">Manage your personal information and study account</p>
      </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 flex items-center justify-center text-white font-bold hover:opacity-90"
                >
                  JD
                </button>
              </div>
